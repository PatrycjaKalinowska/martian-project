...
const Header = () => {
    ...
    return <header className="header">
            <div className="logo">
                <Link className='logo-link' to='/martian-project'>
            ...
            <ul className="menu">
                <nav className='nav-bar' ref={navRef}>
                    <li className="menu-item">
                        <Link className="menu-item-link"to="/martian-project">home</Link>
                    </li>
                    <li className="menu-item">
                        <Link className="menu-item-link"to="/martian-project/news">news</Link>
                    </li>
                    <li className="menu-item">
                        <Link className="menu-item-link"to="/martian-project/gallery">gallery</Link>
                    </li>
                    <li>
